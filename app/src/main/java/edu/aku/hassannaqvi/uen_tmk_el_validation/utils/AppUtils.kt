...
import edu.aku.hassannaqvi.uen_tmk_el_validation.databinding.ChildEndDialogBinding
import edu.aku.hassannaqvi.uen_tmk_el_validation.databinding.GeneralEndDialogBinding
...
fun showDialogActivity(activity: Activity, message: String) {
    val dialog = Dialog(activity)
    dialog.requestWindowFeature(Window.FEATURE_NO_TITLE)
