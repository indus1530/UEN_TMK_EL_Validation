...
public class MaternalDeath extends LiveData<MaternalDeath> {
    ...
    private String elb1 = "-2";
    private String elb2 = "-2";
    private String elb3 = "-2";
    private String elb4 = "-2";
    private String elb5 = "-2";
    private String elb6 = "-2";
    private String elb7 = "-2";
    private String elb8 = "-2";
    private String elb8a = "-2";
    private String elb09 = "-2";
    private String elb10 = "-2";
    private String elb11 = "-2";
    private String elb12 = "-2";
    ...
    public MaternalDeath setGpslat(String gpslat) {
        this.gpslat = gpslat;
        return this;
    }
    ...
    public MaternalDeath setGpslng(String gpslng) {
        this.gpslng = gpslng;
        return this;
    }
    ...
    public MaternalDeath setGpsdate(String gpsdate) {
    ...
    public MaternalDeath setGpsacc(String gpsacc) {
        this.gpsacc = gpsacc;
        return this;
    }
    ...
    public MaternalDeath setDeviceid(String deviceid) {
    ...
    public MaternalDeath setTagid(String tagid) {
        this.tagid = tagid;
        return this;
    }
    ...
    public MaternalDeath Sync(JSONObject jsonObject) throws JSONException {
    ...
    public MaternalDeath Hydrate(Cursor cursor) {
    ...
    public String toString() {
        return new GsonBuilder().create().toJson(this, MaternalDeath.class);
    }
