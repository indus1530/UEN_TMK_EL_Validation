...
public class Anthro extends LiveData<Anthro> {
    ...
    public Anthro setGpslat(String gpslat) {
        this.gpslat = gpslat;
        return this;
    }
    ...
    public Anthro setGpslng(String gpslng) {
        this.gpslng = gpslng;
        return this;
    }
    ...
    public Anthro setGpsdate(String gpsdate) {
    ...
    public Anthro setGpsacc(String gpsacc) {
        this.gpsacc = gpsacc;
        return this;
    }
    ...
    public Anthro setDeviceid(String deviceid) {
    ...
    public Anthro setTagid(String tagid) {
        this.tagid = tagid;
        return this;
    }
    ...
    public Anthro Sync(JSONObject jsonObject) throws JSONException {
    ...
    public String toString() {
        return new GsonBuilder().create().toJson(this, Anthro.class);
    }
