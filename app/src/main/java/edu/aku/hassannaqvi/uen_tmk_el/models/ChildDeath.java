...
public class ChildDeath extends LiveData<ChildDeath> {
    ...
    public ChildDeath setGpslat(String gpslat) {
        this.gpslat = gpslat;
        return this;
    }
    ...
    public ChildDeath setGpslng(String gpslng) {
        this.gpslng = gpslng;
        return this;
    }
    ...
    public ChildDeath setGpsdate(String gpsdate) {
    ...
    public ChildDeath setGpsacc(String gpsacc) {
        this.gpsacc = gpsacc;
        return this;
    }
    ...
    public ChildDeath setDeviceid(String deviceid) {
    ...
    public ChildDeath setTagid(String tagid) {
        this.tagid = tagid;
        return this;
    }
    ...
    public ChildDeath Sync(JSONObject jsonObject) throws JSONException {
    ...
    public ChildDeath Hydrate(Cursor cursor) {
    ...
    public String toString() {
        return new GsonBuilder().create().toJson(this, ChildDeath.class);
    }
