...
public class SectionF01Activity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("raf7ed", bi.raf7ed.getText().toString());

        json.put("raf7em", bi.raf7em.getText().toString());

        json.put("raf7ey", bi.raf7ey.getText().toString());
        ...
        json.put("cmf9hd", bi.cmf9hd.getText().toString());

        json.put("cmf9hm", bi.cmf9hm.getText().toString());

        json.put("cmf9hy", bi.cmf9hy.getText().toString());
