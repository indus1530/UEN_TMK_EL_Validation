...
public final class CreateTable {
    ...
    public static final String SQL_CREATE_FORMS = "CREATE TABLE "
            ...
            + FormsTable.COLUMN_ELC1 + " TEXT,"
            + FormsTable.COLUMN_ELC2 + " TEXT,"
            + FormsTable.COLUMN_ELC3 + " TEXT,"
            + FormsTable.COLUMN_ELC4 + " TEXT,"
            + FormsTable.COLUMN_ELC5 + " TEXT,"
            + FormsTable.COLUMN_ELC6 + " TEXT,"
            + FormsTable.COLUMN_ELC7 + " TEXT,"
            + FormsTable.COLUMN_ELC796 + " TEXT,"
