...
public class Immunization extends LiveData<Immunization> {
    ...
    public Immunization setGpslat(String gpslat) {
        this.gpslat = gpslat;
        return this;
    }
    ...
    public Immunization setGpslng(String gpslng) {
        this.gpslng = gpslng;
        return this;
    }
    ...
    public Immunization setGpsdate(String gpsdate) {
    ...
    public Immunization setGpsacc(String gpsacc) {
        this.gpsacc = gpsacc;
        return this;
    }
    ...
    public Immunization setTagid(String tagid) {
        this.tagid = tagid;
        return this;
    }
