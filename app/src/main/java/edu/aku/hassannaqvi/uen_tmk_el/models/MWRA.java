...
public class MWRA extends LiveData<MWRA> {
    ...
    public MWRA setGpslat(String gpslat) {
        this.gpslat = gpslat;
        return this;
    }
    ...
    public MWRA setGpslng(String gpslng) {
        this.gpslng = gpslng;
        return this;
    }
    ...
    public MWRA setGpsdate(String gpsdate) {
    ...
    public MWRA setGpsacc(String gpsacc) {
        this.gpsacc = gpsacc;
        return this;
    }
    ...
    public MWRA setDeviceid(String deviceid) {
    ...
    public MWRA setTagid(String tagid) {
        this.tagid = tagid;
        return this;
    }
    ...
    public MWRA Sync(JSONObject jsonObject) throws JSONException {
    ...
    public String toString() {
        return new GsonBuilder().create().toJson(this, MWRA.class);
    }
